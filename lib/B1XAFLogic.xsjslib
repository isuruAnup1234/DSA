var B1XAddress = "/sap/xs/annonuser";
...
{
    var path =  B1XAddress + "pervasive/IMCC/srv/pa/service/sale_recommend" + "?cardcode=" + body.CardCode;
...
{
    var path =  B1XAddress + "pervasive/IMCC/srv/pa/service/sale_related" + "?cardcode=" + body.CardCode + "&itemcode=" + body.ItemCode;
